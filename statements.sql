...
SELECT COUNT(DISTINCT edad) AS edades_diferentes_java FROM usuarios_lenguajes WHERE lenguaje = 'Java';

-- Ejercicio 9: Seleccionar los usuarios que no saben ningún lenguaje.
-- Todos tienen lenguaje, entonces: 
...
SELECT COUNT(*) AS total_css_menor_30 FROM usuarios_lenguajes WHERE lenguaje = 'CSS' AND edad < 30;
...
SELECT COUNT(DISTINCT lenguaje) AS lenguajes_diferentes_mayores_25 FROM usuarios_lenguajes WHERE edad > 25;

-- Ejercicio 25: Seleccionar los usuarios que tienen exactamente la misma edad.
SELECT * FROM usuarios_lenguajes WHERE edad IN (
...
SELECT COUNT(*) AS total_apellido_G FROM usuarios_lenguajes WHERE apellido LIKE 'G%';
...
SELECT * FROM usuarios_lenguajes WHERE edad > 30 ORDER BY CHAR_LENGTH(lenguaje) ASC LIMIT 1;
...
SELECT COUNT(*) AS total_20_25 FROM usuarios_lenguajes WHERE edad BETWEEN 20 AND 25 AND lenguaje IS NOT NULL;
...
SELECT nombre, apellido, edad - (SELECT AVG(edad) FROM usuarios_lenguajes) AS diferencia_edad FROM usuarios_lenguajes;

-- Ejercicio 36: Contar cuántos usuarios tienen un lenguaje asociado que contiene la palabra 'Script'.
SELECT COUNT(*) AS total_script FROM usuarios_lenguajes WHERE lenguaje LIKE '%Script%';
...
SELECT COUNT(*) AS total_P_menor_28 FROM usuarios_lenguajes WHERE lenguaje LIKE 'P%' AND edad < 28;
